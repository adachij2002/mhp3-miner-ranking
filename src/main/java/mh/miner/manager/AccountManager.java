...
public class AccountManager implements Serializable {
    ...
    public void init() {
        ...
        guestUser =
                session.selectOne(
                        "mh.miner.entity.TUser.selectById", msg.getString("value.common.guest.id"));
    ...
    public String login() {
        ...
        loginUser = session.selectOne("mh.miner.entity.TUser.selectById", tUser.getId());
        ...
        if (loginUser != null
            ...
            FacesContext.getCurrentInstance()
                    .addMessage(null, new FacesMessage(msg.getString("msg.login.login.failure")));
            return "login";
        }
    }
    ...
    public boolean isLoggedIn() {
        return loginUser != null && !loginUser.getId().equals(guestUser.getId());
    }
}
